...
- Durable results and the proposed experiment backlog live in `EXPERIMENTS_LOG.md`. Append a decision-record entry (date, sources, experiment, metrics, lessons, decision) after each experiment.
